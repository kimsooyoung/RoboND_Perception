...
// ref : https://answers.ros.org/question/361021/i-try-to-catkin_make-with-gazebo-9-but-i-got-these-errors/
...
void GazeboGraspFix::OnUpdate() {
    ...
    for (gripCntIt = this->gripCounts.begin(); gripCntIt != this->gripCounts.end(); ++gripCntIt){
        ...
        for (pointIt=initColls.begin(); pointIt!=initColls.end(); ++pointIt)
        {
            ...
            ignition::math::Matrix4<double> worldToLink = currLinkWorldPose.(); // .GetAsMatrix4();
            // ignition::math::Vector3<double> worldToLink = currLinkWorldPose.Pos();
            ...
            ignition::math::Matrix4 _currContactWorldPose=worldToLink*linkToContact;
